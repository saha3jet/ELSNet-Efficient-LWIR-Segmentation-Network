# Custom Segmentation Project

> Based on [MMSegmentation](https://github.com/open-mmlab/mmsegmentation) by OpenMMLab

This is a custom semantic segmentation project built on top of MMSegmentation framework.
