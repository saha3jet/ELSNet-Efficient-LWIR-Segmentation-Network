...
class ELSHead(BaseDecodeHead):
    def __init__(
        ...
        **kwargs,
        ...
        self.i_head = BaseELSHead(in_channels, channels, norm_cfg, act_cfg)
        self.p_head = BaseELSHead(in_channels // 2, channels, norm_cfg, act_cfg)
