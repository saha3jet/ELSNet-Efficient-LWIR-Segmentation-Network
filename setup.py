...
if __name__ == "__main__":
    ...
    setup(
        ...
        version=get_version(),
        description="Custom Segmentation Project based on MMSegmentation",
        long_description=readme(),
        long_description_content_type="text/markdown",
        author="Your Name",
        author_email="your.email@example.com",
        keywords="computer vision, semantic segmentation, custom",
        url="https://github.com/yourusername/custom-segmentation",
